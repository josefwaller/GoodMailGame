...
const std::map<VehicleModel, VehicleModelInfo> VehicleModelInfo::modelInfos = {
	...
	{ VehicleModel::SlowCargoTruck, VehicleModelInfo(25.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Cargo Truck", 100, Technology::CargoTrucks) },
	{ VehicleModel::FastCargoTruck, VehicleModelInfo(45.0f, Game::UNITS_IN_GAME_HOUR * 1.2, Game::UNITS_IN_GAME_HOUR * 2, "Fast Truck", 100, Technology::FastCargoTrucks) },
	{ VehicleModel::SlowTrain, VehicleModelInfo(20.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Slow Train", 100, Technology::Trains, 200, TRAIN_CARS, 8) },
	{ VehicleModel::FastTrain, VehicleModelInfo(40.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Fast Train", 100, Technology::FastTrains, 400, TRAIN_CARS, 4) },
	{ VehicleModel::SlowAirplane, VehicleModelInfo(300.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Slow Plane", 100, Technology::Airplanes) },
	{ VehicleModel::FastAirplane, VehicleModelInfo(400.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Fast Plane", 100, Technology::FastAirplanes) },
