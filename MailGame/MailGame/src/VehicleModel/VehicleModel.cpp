...
const std::map<VehicleModel, VehicleModelInfo> VehicleModelInfo::modelInfos = {
	...
	{ VehicleModel::SlowTrain, VehicleModelInfo(20.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Slow Train", 400, Technology::Trains, 200, TRAIN_CARS, 8) },
	{ VehicleModel::FastTrain, VehicleModelInfo(100.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Fast Train", 400, Technology::FastTrains, 400, TRAIN_CARS, 4) },
