...
const std::map<VehicleModel, VehicleModelInfo> VehicleModelInfo::modelInfos = {
	...
	{ VehicleModel::FastTrain, VehicleModelInfo(40.0f, Game::UNITS_IN_GAME_HOUR * 0.2, Game::UNITS_IN_GAME_HOUR * 0.2, "Fast Train", 400, Technology::FastTrains, 400, TRAIN_CARS, 4) },
